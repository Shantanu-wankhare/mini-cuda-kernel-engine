...
// ---------------------------------------------------------------------------
// The GemmVariant enum and its ladder rationale moved to
// mcke/kernels/gemm_tile.hpp (included above), alongside GemmTile and the
// (variant, tile) validity predicate. It is a plain enum with no CUDA
// dependency, and keeping it next to the tile it is validated against lets
// gemm_tile_is_supported() take a GemmVariant directly instead of a bool.
